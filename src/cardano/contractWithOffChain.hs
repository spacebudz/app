...
contractInfo = ContractInfo 
    ...
    , owner1 = (pubKeyHash $ Emulator.walletPubKey (Emulator.Wallet 1), toFraction 1.95, toFraction 2, toFraction 2.5)
    , owner2 = (pubKeyHash $ Emulator.walletPubKey (Emulator.Wallet 2), toFraction 0.5)
